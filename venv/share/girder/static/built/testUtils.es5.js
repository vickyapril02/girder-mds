...
girderTest.createCollection = function (collName, collDesc, createFolderName) {
    return function () {
        waitsFor(function () {
            return $('li.active .g-page-number').text() === 'Page 1' && $('.g-collection-create-button').is(':enabled');
        ...
        girderTest.waitForDialog();
        waitsFor(function () {
            return $('input#g-name').length > 0 && $('.g-save-collection:visible').is(':enabled') && $('#collection-description-write .g-markdown-text').is(':visible');
        ...
        waitsFor(function () {
            return $('.g-collection-name').text() === collName && $('.g-collection-description').text().trim() === collDesc;
...
girderTest.createGroup = function (groupName, groupDesc, pub) {
    return function () {
        ...
        waitsFor(function () {
            return $('li.active .g-page-number').text() === 'Page 1' && $('.g-group-create-button:visible').is(':enabled');
        ...
        girderTest.waitForDialog();
        waitsFor(function () {
            return $('#g-dialog-container').hasClass('in') && $('#g-access-public:visible').length > 0 && $('#g-name:visible').length > 0 && $('#g-description:visible').length > 0 && $('.g-save-group:visible').length > 0;
        ...
        if (pub) {
            ...
            waitsFor(function () {
                return $('.g-save-group:visible').length > 0 && $('.radio.g-selected').text().match('Public').length > 0;
        ...
        waitsFor(function () {
            return $('.g-group-name').text() === groupName && $('.g-group-description').text() === groupDesc;
...
girderTest.testMetadata = function () {
        ...
        runs(function () {
            ...
            if (action === 'save') {
                if (beforeType === 'json') {
                    ...
                    expect(afterElem.attr('g-value')).toBe(JSON.stringify(JSON.parse(beforeValue)));
                } else {
                    expect(afterElem.attr('g-value')).toBe(JSON.stringify(JSON.parse(beforeValue), null, 4));
                }
    ...
    function _editMetadata(origKey, key, value, action, errorMessage, type) {
        ...
        waitsFor(function () {
            return $('input.g-widget-metadata-key-input').length === 1 && (type === 'simple' ? $('textarea.g-widget-metadata-value-input').length === 1 : $('.jsoneditor > .jsoneditor-outer > .jsoneditor-tree').length === 1);
        ...
        waitsFor(function () {
            return $('input.g-widget-metadata-key-input').length === 0 && (type === 'simple' ? $('textarea.g-widget-metadata-value-input').length === 0 : $('.jsoneditor > .jsoneditor-outer > .jsoneditor-tree').length === 0);
        }, 'edit fields to disappear');
        waitsFor(function () {
    ...
    return function () {
        ...
        _editMetadata(null, 'unicode_key\xA9\uD834\uDF06', 'unicode_value\xA9\uD834\uDF06');
...
girderTest.waitForLoad = function (desc) {
    ...
    waitsFor(function () {
        ...
        if ($('.modal').data('bs.modal').isShown !== false && $('.modal').data('bs.modal').isShown !== null) {
            return false;
        }
    ...
    var clearCount = 0;
    waitsFor(function () {
        if (girder._inTransition || girder.rest.numberOutstandingRestRequests() || $('.g-loading-block').length) {
            clearCount = 0;
            return false;
        }
        clearCount += 1;
...
girderTest.waitForDialog = function (desc) {
     ...
     */
    waitsFor(function () {
        return $('.modal').data('bs.modal') && $('.modal').data('bs.modal').isShown === true && $('#g-dialog-container:visible').length > 0;
    }, 'a dialog to fully render' + desc);
    waitsFor(function () {
...
girderTest.addScript = function (url) {
    girderTest.promise = girderTest.promise.then(_.partial($.getScript, url)).catch(function () {
...
girderTest.folderAccessControl = function (current, action, recurse) {
    ...
    waitsFor(function () {
        return $('#g-dialog-container').hasClass('in') && $('#g-access-private:visible').is(':enabled');
        ...
        (function (impl) {
            XMLHttpRequest.prototype.send = function (data) {
                if (data && data instanceof Blob) {
                    ...
                    if (girderTest._uploadData.length && girderTest._uploadData.length === data.size && !girderTest._uploadDataExtra) {
                        data = girderTest._uploadData;
                    } else {
                        data = new Array(data.size + 1 + girderTest._uploadDataExtra).join('-');
                    }
                }
                impl.call(this, data);
            };
...
girderTest.testUpload = function (uploadItem, needResume, error) {
    ...
    waitsFor(function () {
        return $('.g-drop-zone:visible').length > 0 && $('.modal-dialog:visible').length > 0;
    ...
    if (needResume) {
        waitsFor(function () {
            return $('.g-resume-upload:visible').length > 0 || $('.g-restart-upload:visible').length > 0;
        }, 'the resume link to appear');
        runs(function () {
            if (error) {
                expect($('.g-upload-error-message').text().indexOf(error) >= 0).toBe(true);
            }
            girderTest._uploadDataExtra = 0;
    ...
    waitsFor(function () {
        return $('.modal-content:visible').length === 0 && $('.g-item-list-entry').length === origLen + 1;
...
(function () {
    ...
    Backbone.$.ajax = function () {
        ...
        return backboneAjax.call(Backbone.$, opts).done(function (data, textStatus) {
...
$(function () {
    ...
    if (specs.length) {
        $.when.apply($, specs).done(function () {
